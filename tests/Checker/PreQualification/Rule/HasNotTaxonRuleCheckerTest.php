...
final class HasNotTaxonRuleCheckerTest extends TestCase
{
    use ProphecyTrait;

    private HasNotTaxonRuleChecker $checker;

    protected function setUp(): void
    {
        $this->checker = new HasNotTaxonRuleChecker();
    }

    /**
     * @test
     */
    public function it_returns_true_if_product_does_not_have_taxon(): void
    {
     ...
     * @test
     */
    public function it_returns_false_if_product_has_taxon(): void
    {
     ...
     * @test
     */
    public function it_returns_false_if_product_has_main_taxon(): void
    {
        $taxon = $this->prophesize(TaxonInterface::class);
        $taxon->getCode()->willReturn('TAXON_CODE');
